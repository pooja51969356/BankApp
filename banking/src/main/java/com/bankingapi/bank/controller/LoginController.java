...
public class LoginController {
	...
	@GetMapping("/api/user/login/{customerId}")
	public ResponseEntity<LoginResponseDto> userLogin(@PathVariable String customerId,@RequestHeader("password") String password) {
		
		LoginDetails details=new LoginDetails(customerId, password);
